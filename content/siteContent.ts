...
export const about = {
  ...
  section3: {
    ...
    paragraphs: [
      ...
      "The journal stays open. It becomes the working surface for the rest of the day. From inside it, I triage my task list, manage my calendar, and connect to Gmail.",
